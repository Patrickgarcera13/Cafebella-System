...
body {
  ...
  background: linear-gradient(135deg, #f4f7f4 0%, #e8f5e9 40%, #fdfdfd 100%);
  color: var(--text);
  line-height: 1.6;
}
body::before {
  ...
  width: 400px;
  height: 400px;
  background: radial-gradient(circle, rgba(67,160,71,0.25), transparent);
  z-index: -1;
}
...
body::after {
  ...
  width: 400px;
  height: 400px;
  background: radial-gradient(circle, rgba(27,94,32,0.2), transparent);
  z-index: -1;
}
:root {
  --primary: #1b5e20;
...
.card:hover {
  ...
  box-shadow: 0 14px 35px rgba(27,94,32,0.10);
}
.section-title {
  display: flex;
  align-items: center;
...
.section-title::before {
  ...
  width: 4px;
  height: 20px;
  background: linear-gradient(180deg, #114500, #43a047);
  border-radius: 5px;
}
/******************************** INPUTS (KEEP YOUR DESIGN) ********************************/
input,
select,
textarea {
  width: 100%;
...
textarea:focus {
  background: #fff;
  border-color: #114500;
  box-shadow: 0 0 0 3px rgba(17,69,0,0.1);
}
label {
  font-size: 14px;
  display: block;
...
.service-box:hover {
  ...
  border-color: #114500;
  box-shadow: 0 10px 25px rgba(17,69,0,0.15);
}
.service-box.active {
...
.field select {
  ...
  padding: 12px 14px;
  border-radius: 10px;
  border: 1px solid rgba(17,69,0,0.2);
  font-size: 13px;
  transition: 0.2s;
}
...
.book-btn {
  ...
  background: linear-gradient(135deg, #114500, #2e7d32);
  color: #ffffff;
  ...
  box-shadow: 0 12px 30px rgba(17, 69, 0, 0.18);
  transition: all 0.3s ease;
}
.book-btn:hover {
  transform: translateY(-4px);
  box-shadow: 0 18px 40px rgba(17, 69, 0, 0.25);
  background: linear-gradient(135deg, #0d3600, #1b5e20);
}
.book-btn:active {
...
#guest-count {
  ...
  height: 58px;
  padding: 0 20px;
  border: 2px solid rgba(17, 69, 0, 0.18);
  border-radius: 18px;
  background: #ffffff;
  font-family: 'Inter', sans-serif;
  font-size: 15px;
  ...
  box-shadow: 0 6px 18px rgba(17, 69, 0, 0.04);
  transition: all 0.25s ease;
}
#event-location {
  padding: 10px 25px;
...
#guest-count:focus {
  border-color: #114500;
  box-shadow: 0 0 0 4px rgba(17, 69, 0, 0.08);
...
.payment-box input:checked + span::before {
  content: "✔ ";
}
/******************************** FOOTBAR ********************************/
.footbar {
    ...
    <div class="row">
      ...
      <div style="flex:1;">
        ...
        <input type="tel" 
          ...
          pattern="[0-9]{10,11}" 
          inputmode="numeric"
          title="Please enter 10-11 digits only"
          required>      
      </div>
    </div>
  </div>
...
<div class="form-group">
  ...
  <!-- 🔴 ERROR MESSAGE DITO -->
  <div id="guest-error" style="color:red; font-size:12px; margin-top:5px;"></div>
  ...
  <small style="color:#666;">
    Minimum of 30 guests required
        ...
        <div class="form-group">
          ...
          <input type="text" id="street" name="street" placeholder="House No. and Street" required>
        </div>
...
<div class="card rise-item">
  ...
  <label style="margin-top:10px;">Select Payment Type</label>
...
<div class="card rise-item">
  ...
  <div style="font-size:13px; line-height:1.5;">
    ...
    <p style="margin-bottom:10px;">
      Please take a moment to review our Terms and Conditions to ensure a smooth and hassle-free booking experience with Cafe BELLA.
    </p>

    <ul style="padding-left:18px; margin-bottom:10px;">
      <li>Bookings must be made at least one (1) week in advance.</li>
      <li>The ₱2,000 reservation fee applies only to Coffee Booth and Matcha Booth bookings.<br>For Tattoo Event bookings, the fee does not apply as it is an in-store service (2 minimalist tattoos for ₱1,000, in-store only).</li>
      <li>Payments accepted: GCash and Cash.</li>
      <li>Remaining balance must be settled before or on the event date.</li>
      <li>Reservation fee is non-refundable.</li>
      <li><strong>No cancellation policy.</strong> Once a booking is confirmed, it cannot be canceled.</li>
      <li>Clients must provide accurate event details.</li>
      <li>Cafe BELLA may adjust bookings due to unforeseen circumstances.</li>
    </ul>
  </div>
</div>
...
<div class="card" style="display:flex; align-items:center; gap:10px;">
  ...
  <input type="checkbox" id="agree" style="width:18px; height:18px;">

  <label for="agree" style="font-size:13px;">
    I agree to the terms and conditions and booking policies of Cafe BELLA.
  </label>

</div>

<!-------------------------------- BUTTON ------------------------------------->
<button id="complete-booking" class="book-btn" style="width:100%; max-width:400px;">
  Complete Booking
</button>
</div>
...
<p style="text-align:center; font-size:12px; margin-top:10px;">
  Need help? Contact us at @cafeBELLA on Facebook or Messenger
</p>
</div>
<!-------------------------------- FOOTBAR ------------------------------------->
